<template>
	<view class="wrap">
		<u-navbar title="登录" :border-bottom="false"></u-navbar>
		<view class="top"></view>
		<view class="content">
		...
		<view class="buttom">
			<view class="loginType">
				...
				<view class="QQ item">
					<view class="icon" @click="qqlogin"><u-icon size="70" name="qq-fill" color="rgb(17,183,233)"></u-icon></view>
					QQ
				</view>
			</view>
			<view class="hint">
				...
				并授权使用您的账号信息（如昵称、头像、手机号）以便您统一管理
			</view>
		</view>
	</view>
</template>
